...
class Level_7 extends StatefulWidget {
  const Level_7({super.key});

  @override
  State<Level_7> createState() => _Level_7State();
}

class _Level_7State extends State<Level_7> {
  ...
  void initState() {
    ...
    yellow = Target(index: 11, color: c.yellow);
    purple = Target(index: 12, color: c.purple);
    amber = Target(index: 13, color: c.amber);
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      g.targets = [green, blue, yellow, purple, amber];
      ...
      await g.left(amber, lastMove: true);
