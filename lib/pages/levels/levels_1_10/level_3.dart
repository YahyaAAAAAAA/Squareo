...
class Level_3 extends StatefulWidget {
  const Level_3({super.key});

  @override
  State<Level_3> createState() => _Level_3State();
}

class _Level_3State extends State<Level_3> {
  ...
  void initState() {
    ...
    green = Target(index: 1, color: c.green);
    blue = Target(index: 10, color: c.blue);
